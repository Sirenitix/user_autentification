...
public class DBServiceImpl implements DBService {
    ...
    private final String SQL_DELETE_ACCOUNT = "DELETE FROM account WHERE bankid=?";
    ...
    public Account getClientAccountById(int id) {
    ...
    @Override
    public void deleteClientAccountById(int id) {
